...
cursor.execute("select * from ordinateur")
...
f = open("C:/wamp/www/web/images/PC/testpc.txt", "w")
np.savetxt('C:/wamp/www/web/images/testpc.txt',matriceSimilariteBin,fmt='%.2f',delimiter=",")
