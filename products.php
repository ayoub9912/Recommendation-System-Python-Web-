								...
								<div class="row">
									<div class="col-sm-3">
										<ul class="multi-column-dropdown">
											<h6>PC Gamer</h6>
											<li><a href="products.php">PC Gamer Bureau</a></li>
											<li><a href="products1.php">Smartphones  <span>New</span></a></li> 
	...
	<div class="mobiles">
		<div class="container">
			<div class="w3ls_mobiles_grids">
				...
				<div class="col-md-10 w3ls_mobiles_grid_right">
					...
					<div class="w3ls_mobiles_grid_right_grid3">
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							<div class="">
								<div >
									<img src="images/PC/1.jpg" alt=" " class="img-responsive" />
								...
								<h5><a href="singles/singlespc/singlepc1.php">Pc de Bureau PARASITE i3 9è Gén 8Go 240 Go SSD </a></h5> 
						...
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							<div class="">
								<div  >
									<img src="images/PC/2.jpg" alt=" " class="img-responsive" />
								...
								<h5><a href="http://localhost/web/singles/singlespc/singlepc2.php">Pc de Bureau Gamer ADVANCE i5 9è Gén 8Go 240 Go SSD</a></h5>
								<div class="simpleCart_shelfItem">
						...
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							<div class="">
								...
								<h5><a href="http://localhost/web/singles/singlespc/singlepc3.php">Pc de Bureau Gamer Spirit Deathmatch 7 i5 9è Gén 8</a></h5>
								<div class="simpleCart_shelfItem">
					...
					<div class="w3ls_mobiles_grid_right_grid3">
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							<div class="">
								...
								<h5><a href="http://localhost/web/singles/singlespc/singlepc4.php">Pc de Bureau Gamer Spirit Deathmatch 5 i5 9è Gén 8</a></h5>
								<div class="simpleCart_shelfItem">
									<p><span>DT250</span> <i class="item_price">DT245</i></p>
									<form action="#" method="post">
										<input type="hidden" name="cmd" value="_cart" />
						...
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							<div class="">
								...
								<h5><a href="http://localhost/web/singles/singlespc/singlepc5.php">Pc de Bureau Gamer SHARKOON i5 9è Gén 8Go 240Go SSD</a></h5>
								<div class="simpleCart_shelfItem">
						...
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							<div class="">
								...
								<h5><a href="http://localhost/web/singles/singlespc/singlepc6.php">Pc de Bureau Gamer SPIRIT OF GAMER GHOST ONE i5 9ème GEN</a></h5>
								<div class="simpleCart_shelfItem">
					...
					<div class="w3ls_mobiles_grid_right_grid3">
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							<div class="">
								...
								<h5><a href="http://localhost/web/singles/singlespc/singlepc7.php">Pc Portable Gamer LENOVO L340 i5 9é Gén 8Go 2To </a></h5>
								<div class="simpleCart_shelfItem">
						  ...
						  <div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							  <div class="">
								...
								<h5><a href="http://localhost/web/singles/singlespc/singlepc8.php">Pc Portable ASUS ROG Zephyrus GA502 AMD Ryzen 8Go </a></h5>
								   <div class="simpleCart_shelfItem">
						     ...
						     <div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							  <div class="">
								<div  >
								  ...
								  <h5><a href="http://localhost/web/singles/singlespc/singlepc9.php">PC Portable HP Gaming Pavilion 15-ec0004nk AMD Ryze</a></h5>
								<div class="simpleCart_shelfItem">
						  ...
						  <div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							  <div class="">
								<div  >
									<img src="images/PC/10.jpg" alt=" " class="img-responsive" />
								  ...
								  <h5><a href="http://localhost/web/singles/singlespc/singlepc10.php">PC Portable Gamer MSI GF63 i5 10è Gén 16Go 512 Go </a></h5>
								  <div class="simpleCart_shelfItem">
									<p><span>DT250</span> <i class="item_price">DT210</i></p>
									<form action="#" method="post">
										<input type="hidden" name="cmd" value="_cart" />
						...
						<div class="clearfix"> </div>
							...
							<div class="">
								<div  >
									<img src="images/PC/11.jpg" alt=" " class="img-responsive" />
								...
								<h5><a href="http://localhost/web/singles/singlespc/singlepc11.php">Pc Portable ASUS ROG STRIX G531GT i7 9é Gén 16Go 5</a></h5>
								<div class="simpleCart_shelfItem">
									<p><span>DT250</span> <i class="item_price">DT210</i></p>
									<form action="#" method="post">
										<input type="hidden" name="cmd" value="_cart" />
						    ...
						    <div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							    <div class="">
								<div  >
									<img src="images/PC/12.jpg" alt="" class="img-responsive" />
								  ...
								  <h5><a href="http://localhost/web/singles/singlespc/singlepc12.php">Pc Portable MSI GF75 THIN 9RCX i7 8Go 512Go SSD</a></h5>
								  <div class="simpleCart_shelfItem">
									<p><span>DT250</span> <i class="item_price">DT210</i></p>
									<form action="#" method="post">
										<input type="hidden" name="cmd" value="_cart" />
							 ...
							 <div class="">
								<div  >
									<img src="images/PC/13.jpg" alt=" " class="img-responsive" />
								...
								<h5><a href="http://localhost/web/singles/singlespc/singlepc13.php">Pc de Bureau MSI Gamer AEGIS TI3 8RD i7 8è Gén 32GB</a></h5>
								<div class="simpleCart_shelfItem">
									<p><span>DT250</span> <i class="item_price">DT210</i></p>
									<form action="#" method="post">
										<input type="hidden" name="cmd" value="_cart" />
							...
							<div class="">
								<div  >
									<img src="images/PC/14.jpg" alt=" " class="img-responsive" />
								...
								<h5><a href="http://localhost/web/singles/singlespc/singlepc14.php">Pc de Bureau Gamer Spirit Clone 2 i5 9è Gén 16Go 1</a></h5>
								<div class="simpleCart_shelfItem">
									<p><span>DT250</span> <i class="item_price">DT210</i></p>
									<form action="#" method="post">
										<input type="hidden" name="cmd" value="_cart" />
										<input type="hidden" name="add" value="1" /> 
										<input type="hidden" name="w3ls_item" value="Pc de Bureau Gamer Spirit Clone 2 i5 9è Gén 16Go 1	" /> 
										<input type="hidden" name="amount" value="210.00"/>   
										<button type="submit" class="w3ls-cart"> Ajouter au panier</button>
									</form>
								</div> 
