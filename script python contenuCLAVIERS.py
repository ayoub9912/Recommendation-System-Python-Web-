...
cursor.execute("select * from claviers")
...
f = open("C:/wamp/www/web/images/claviers/testclaviers.txt", "w")
np.savetxt('C:/wamp/www/web/images/claviers/testclaviers.txt',matriceSimilariteBin,fmt='%.2f',delimiter=",")
