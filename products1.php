					...
					<div class="w3ls_mobiles_grid_right_grid3">
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							<div class="">
								...
								<h5><a href="singles/singlesphones/singlephone1.php">Smartphone LENOVO B A2016 4G Gold </a></h5> 
						...
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							<div class="">
								<div  >
									<img src="images/Phones/2.jpg" alt=" " class="img-responsive" />
								...
								<h5><a href="http://localhost/web/singles/singlesphones/singlephone2.php">Smartphone IKU Y2 - Noir</a></h5>
								<div class="simpleCart_shelfItem">
						...
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							<div class="">
								...
								<h5><a href="http://localhost/web/singles/singlesphones/singlephone3.php">Smartphone IPRO L50 3G+ - Gold</a></h5>
								<div class="simpleCart_shelfItem">
					...
					<div class="w3ls_mobiles_grid_right_grid3">
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							<div class="">
								...
								<h5><a href="http://localhost/web/singles/singlesphones/singlephone4.php">Smartphone IKU Y3 - Gold (IKU-Y3-GOLD)</a></h5>
								<div class="simpleCart_shelfItem">
									<p><span>DT250</span> <i class="item_price">DT245</i></p>
									<form action="#" method="post">
										<input type="hidden" name="cmd" value="_cart" />
						...
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							<div class="">
								...
								<h5><a href="http://localhost/web/singles/singlesphones/singlephone5.php">Smartphone EVERTEK M10 3G Bleu</a></h5>
								<div class="simpleCart_shelfItem">
						...
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							<div class="">
								...
								<h5><a href="http://localhost/web/singles/singlesphones/singlephone6.php">Smartphone EVERTEK M10 3G Rouge</a></h5>
								<div class="simpleCart_shelfItem">
					...
					<div class="w3ls_mobiles_grid_right_grid3">
						<div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							<div class="">
								...
								<h5><a href="http://localhost/web/singles/singlesphones/singlephone7.php">Smartphone NOKIA 2.3 Vert</a></h5>
								<div class="simpleCart_shelfItem">
						  ...
						  <div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							  <div class="">
								<div  >
									<img src="images/Phones/8.jpg" alt=" " class="img-responsive" />
								...
								<h5><a href="http://localhost/web/singles/singlesphones/singlephone8.php">Smartphone NOKIA 2.3 Gris </a></h5>
								   <div class="simpleCart_shelfItem">
						     ...
						     <div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							  <div class="">
								<div  >
									<img src="images/Phones/9.jpg" alt=" " class="img-responsive" />
								  ...
								  <h5><a href="http://localhost/web/singles/singlesphones/singlephone9.php">Smartphone OPPO A12 - Noir </a></h5>
								<div class="simpleCart_shelfItem">
						  ...
						  <div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							  <div class="">
								<div  >
									<img src="images/Phones/10.jpg" alt=" " class="img-responsive" />
								  ...
								  <h5><a href="http://localhost/web/singles/singlesphones/singlephone10.php">Smartphone OPPO A12 - Bleu</a></h5>
								  <div class="simpleCart_shelfItem">
									<p><span>DT250</span> <i class="item_price">DT210</i></p>
									<form action="#" method="post">
										<input type="hidden" name="cmd" value="_cart" />
						...
						<div class="clearfix"> </div>
							...
							<div class="">
								<div  >
									<img src="images/Phones/11.jpg" alt=" " class="img-responsive" />
								...
								<h5><a href="http://localhost/web/singles/singlesphones/singlephone11.php">Smartphone HUAWEI Y6s 2019 - Noir</a></h5>
								<div class="simpleCart_shelfItem">
									<p><span>DT250</span> <i class="item_price">DT210</i></p>
									<form action="#" method="post">
										<input type="hidden" name="cmd" value="_cart" />
						    ...
						    <div class="col-md-4 agileinfo_new_products_grid agileinfo_new_products_grid_mobiles">
							    <div class="">
								<div  >
									<img src="images/Phones/12.jpg" alt="" class="img-responsive" />
								  ...
								  <h5><a href="http://localhost/web/singles/singlesphones/singlephone12.php">Smartphone SAMSUNG Galaxy A10s Rouge (SM-A107F-RED)</a></h5>
								  <div class="simpleCart_shelfItem">
									<p><span>DT250</span> <i class="item_price">DT210</i></p>
									<form action="#" method="post">
										<input type="hidden" name="cmd" value="_cart" />
							 ...
							 <div class="">
								<div  >
									<img src="images/Phones/13.jpg" alt=" " class="img-responsive" />
								...
								<h5><a href="http://localhost/web/singles/singlesphones/singlephone13.php">Smartphone ALCATEL 3X 2019 - Noir (ALCATEL-3X-BLACK)</a></h5>
								<div class="simpleCart_shelfItem">
									<p><span>DT250</span> <i class="item_price">DT210</i></p>
									<form action="#" method="post">
										<input type="hidden" name="cmd" value="_cart" />
